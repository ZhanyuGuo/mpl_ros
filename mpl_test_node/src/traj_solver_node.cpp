...
int main(int argc, char **argv)
{
  ...
  ros::Publisher min_vel_traj_pub = nh.advertise<planning_ros_msgs::Trajectory>("min_vel_trajectory", 1, true);
  ros::Publisher min_acc_traj_pub = nh.advertise<planning_ros_msgs::Trajectory>("min_acc_trajectory", 1, true);
  ros::Publisher min_jrk_traj_pub = nh.advertise<planning_ros_msgs::Trajectory>("min_jrk_trajectory", 1, true);
  ros::Publisher min_snp_traj_pub = nh.advertise<planning_ros_msgs::Trajectory>("min_snp_trajectory", 1, true);

  ros::Publisher path_pub = nh.advertise<planning_ros_msgs::Path>("path", 1, true);
